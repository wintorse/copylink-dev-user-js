...
export const i18nMessages = {
  ja: {
    ...
    shortcutCopyGoogleSheetsRange:
      "スプレッドシートの選択範囲のリンクを以下の形式でコピー",
    sheetsRangeFormatHtml: "テキストリンク（HTML 形式）",
    sheetsRangeFormatHtmlWithEmoji:
      "Slack 絵文字つきテキストリンク（HTML 形式）",
    sheetsRangeFormatMarkdown: "Markdown 形式",
    sheetsRangeFormatPlainUrl: "URL のみ",
    ...
    githubDraftPullRequest: "GitHub Pull Request（Draft）",
    githubOpenPullRequest: "GitHub Pull Request（Open）",
    githubMergedPullRequest: "GitHub Pull Request（Merged）",
    githubClosedPullRequest: "GitHub Pull Request（Closed）",
  ...
  en: {
    ...
    shortcutCopyGoogleSheetsRange:
      "Copy Google Sheets range link in the following format",
    sheetsRangeFormatHtml: "Text link (HTML)",
    sheetsRangeFormatHtmlWithEmoji: "Text link with Slack emoji (HTML)",
    sheetsRangeFormatMarkdown: "Markdown",
    sheetsRangeFormatPlainUrl: "URL only",
  ...
  "zh-CN": {
    ...
    shortcutCopyGoogleSheetsRange: "按照以下格式复制Google表格选定范围的链接",
    sheetsRangeFormatHtml: "文本链接（HTML 格式）",
    sheetsRangeFormatHtmlWithEmoji: "带Slack表情的文本链接（HTML 格式）",
    sheetsRangeFormatMarkdown: "Markdown 格式",
    sheetsRangeFormatPlainUrl: "仅 URL",
    userShortcuts: "快捷键",
